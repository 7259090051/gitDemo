...
// }
 ...
 filesPicked(e) {
    for (var i = 0; i < e.target.files.length; i++) {
     ...
     this.lengthOfFiles=e.target.files.length
//console.log(e.target.files.length)
  ...
  //var str = "public/inline.js";
      ...
      console.log(a)
        this.makeFileRequest("/projectSelection/"+a,[],this.theFiles,i,this.lengthOfFiles).then((result) => {
...
//         });
//     }
        makeFileRequest(url: string, params: Array<string>, files: Array<File>,i:number,l:number) {
             console.log(' i '+i);
            // console.log("url  "+url)
        ...
        //   for(var i = 0; i < files.length; i++) {
          //      console.log(files.length)
           formData.append(this.relativePath , files[i], files[i].name,i,l);
